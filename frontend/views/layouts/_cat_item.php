    ...
    if(is_array($sub_categories) && count($sub_categories) > 0){
        ...
        <ul class="sub-menu nav-dropdown nav-dropdown-default">
            ...
            foreach ($sub_categories as $cat_level_1){
                ...
                ?>
                <li id="menu-item-<?=$cat_level_1['id']?>" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-has-children menu-item-<?=$cat_level_1['id']?> nav-dropdown-col">
                    ...
                    if(is_array($sub_categories_level_2) && count($sub_categories_level_2) > 0){ ?>
                        <ul class="sub-menu nav-column nav-dropdown-default">
                            ...
                            foreach ($sub_categories_level_2 as $cat_level_2){
                                ...
                                <li id="menu-item-<?=$cat_level_2['id']?>" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-<?=$cat_level_2['id']?>">
