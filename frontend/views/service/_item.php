...
use yii\helpers\Url;
$url_detail = Url::toRoute(['service/detail', 'slug' => $model['slug']]);
?>
            ...
            <div class="box box-vertical box-text-bottom box-blog-post has-hover">
                <div class="box-image" style="width:40%;">
                    <div class="image-cover" style="padding-top:56%;">
                        <img src="<?php echo CFunction::buildThumbnail($model,350,263);?>" class="attachment-medium size-medium wp-post-image lazy-load-active" alt="<?php echo $model['title']?>">
                    </div>
                </div>
