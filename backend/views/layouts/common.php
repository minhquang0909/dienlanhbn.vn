                ...
                echo Menu::widget([
                    ...
                    'items'=>[
                        ...
                        [
                            ...
                            'items'=>[
                                    ['label'=>'Danh mục sản phẩm', 'url'=>['/product-category/index'], 'icon'=>'<i class="fa fa-folder-open-o"></i>'],
                                    ['label'=>'Sản phẩm', 'url'=>['/product/index'], 'icon'=>'<i class="fa fa-product-hunt"></i>'],
                                    ['label'=>'Đơn hàng', 'url'=>['/product-orders/index'], 'icon'=>'<i class="fa fa-shopping-cart"></i>'],
                                    //['label'=>'Nhà cung cấp', 'url'=>['/supplier/index'], 'icon'=>'<i class="fa fa-university" aria-hidden="true"></i>'],
                                    //['label'=>'Quốc gia', 'url'=>['/country/index'], 'icon'=>'<i class="fa fa-globe" aria-hidden="true"></i>'],
                            ]
                        ],
                        [
                            'label'=>'Dịch vụ',
                            ...
                            'options'=>['class'=>'treeview'],
                            'items'=>[
                                ['label'=>'Danh mục dịch vụ', 'url'=>['/service-category/index'], 'icon'=>'<i class="fa fa-folder-open-o"></i>'],
                                ['label'=>'Dịch vụ', 'url'=>['/service/index'], 'icon'=>'<i class="fa fa-product-hunt"></i>'],
                            ]
                        ],
                        [
                            'label'=>'Tin tức',
