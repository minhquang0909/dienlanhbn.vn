...
$this->title = Yii::t('backend', 'Danh mục sản phẩm');
...
<div class="product-category-index">
    ...
    <p>
        <?php echo Html::a(Yii::t('backend', 'Tạo mới danh mục sản phẩm'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
</div>
