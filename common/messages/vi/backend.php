...
return [
    ...
    'Gallery Categories' => 'Danh mục gallery',
    'Create Gallery Category' => 'Tạo mới danh mục gallery',
    'Update gallery category' => 'Cập nhật danh mục gallery',
    'Album categories' => 'Danh mục album ảnh',
    'Album category' => 'Danh mục Album ảnh',
    'Update album category' => 'Cập nhật danh mục Album ảnh',
    'Create album category' => 'Tạo mới danh mục album ảnh',
    'Album' => 'Album ảnh',
    'Create album' => 'Tạo mới album ảnh',
    'Update album' => 'Cập nhật album ảnh',
    'Banner' => 'Banner',
    'Create Banner' => 'Tạo mới banner',
    'Update banner' => 'Cập nhật banner',
    'Text Block' => 'Tùy chọn',
    'Countries' => 'Quốc gia',
    'Create country'    =>  'Tạo mới quốc gia',
    'Suppliers'         =>  'Nhà cung cấp',
    'Create supplier'   =>  'Tạo mới nhà cung cấp',
    'Product'           =>  'Sản phẩm',
